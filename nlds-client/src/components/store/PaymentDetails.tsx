...
export default function PaymentDetails() {
  ...
  return (
    ...
    >
      ...
      >
        <p
          style={{ fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.75, fontWeight: 300 }}
        >
          Complete the bank transfer using the details below. Upload your payment receipt in the next section to finalize the mission request.
        </p>
      </div>
      ...
      <div className="px-6 py-7 sm:px-8 sm:py-8 flex flex-col gap-6">
        {[
          ...
          <div key={label} className="flex flex-col gap-1.5">
            ...
            <span
              style={{ fontSize: "1.05rem", color: "#ffffff", fontWeight: 400, letterSpacing: "0.02em" }}
            >
              {value}
            </span>
          </div>
        ...
        >
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <span
              ...
              style={{ fontSize: "1.25rem", color: "#ffffff", letterSpacing: "0.1em", fontWeight: 600 }}
            >
            ...
            <button
              ...
              style={{
                ...
                background: copied ? "rgba(196,30,58,0.25)" : "rgba(255,255,255,0.05)",
        ...
        <div className="flex flex-col gap-2 pt-1">
          ...
          <p style={{ fontSize: "0.88rem", color: "var(--text-muted)", lineHeight: 1.7, fontWeight: 300 }}>
