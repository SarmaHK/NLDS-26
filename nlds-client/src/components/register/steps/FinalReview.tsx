...
export default function FinalReview({ onEditStep }: FinalReviewProps) {
  ...
  const readinessObj = READINESS_OPTIONS.find(
    (o) => o.level === mr.readinessLevel,
  );
    ...
    <div className="flex flex-col gap-8">
      ...
      <ReviewSection title="PERSONAL INTEL" stepIndex={0}>
        ...
        <DataRow
          ...
          value={
            fileSecured(pi.profilePicture)
              ? "✓ Profile photo secured"
              : undefined
          }
        />
      ...
      <ReviewSection title="MISSION INTEL" stepIndex={3}>
        ...
        <DataRow
          ...
          value={mi.additionalInformation}
        />
      </ReviewSection>
      ...
      <ReviewSection title="MISSION READINESS" stepIndex={4}>
        <DataRow
          ...
          value={readinessObj ? `Level ${readinessObj.level}` : undefined}
        />
