export type RealtimeRegistrationStatus = "DRAFT" | "SUBMITTED" | "UNDER_REVIEW" | "ACCEPTED" | "REJECTED" | "CANCELLED";
...
export interface ServerToClientEvents {
    ...
    REGISTRATION_STATUS_CHANGED: (payload: RegistrationStatusChangedPayload) => void;
