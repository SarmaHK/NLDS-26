...
export const STATUS_MAP: Record<RegistrationClientStatus, StatusContent> = {
  ...
  UNDER_REVIEW: {
    ...
    message:
      "Your mission is currently being reviewed. Please allow the Conference Team some time to complete the assessment.",
    stageIndex: 1,
  },
  ACCEPTED: {
  ...
  REJECTED: {
    ...
    message:
      "This mission was not selected for the current operation. Thank you for accepting the challenge.",
    stageIndex: 2,
  },
};
...
export const TIMELINE_STAGES = [
  {
    ...
    title: "DOSSIER RECEIVED",
    description:
      "Your registration has been securely received by the Conference Team.",
  },
  {
    id: 1,
    title: "MISSION UNDER REVIEW",
    description:
      "Your mission is currently being reviewed by the Conference Team.",
  },
  {
    id: 2,
    title: "DECISION",
