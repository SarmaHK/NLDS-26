    ...
    return (
        <div className="w-full">
            ...
            <div className="block lg:hidden">
                <MobileIndicator currentStep={currentStep} completedSteps={completedSteps} />
            </div>
        </div>
    );
}
            ...
            <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2 min-w-0">
                    <span
                        ...
                        style={{ background: "var(--red)" }}
                    />
                    <span className="font-classified text-[9px] tracking-[0.22em] uppercase tabular" style={{ color: "var(--red)" }}>
                        {String(currentStep + 1).padStart(2, "0")} / {String(TOTAL_STEPS).padStart(2, "0")}
                    </span>
                </div>
