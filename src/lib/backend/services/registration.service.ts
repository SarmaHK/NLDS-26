...
export class RegistrationService {
    ...
    async submitRegistration(
        ...
        if (participantData.personalEmail.toLowerCase().endsWith("@aiesec.net")) {
            throw new Error("Please provide your personal email address, not your AIESEC email.");
        }
        ...
        if (pPhone === gPhone) {
            throw new Error("Guardian contact number must be different from your personal phone number.");
        }
